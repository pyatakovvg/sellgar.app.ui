...
export { FrameRouterScope } from './frame-router-scope.ts';
export { ModuleScope } from './module-scope.ts';
export { ProviderScope, type ProviderScopeInstance, type SingletonProviderScopeInstance } from './provider-scope.ts';
