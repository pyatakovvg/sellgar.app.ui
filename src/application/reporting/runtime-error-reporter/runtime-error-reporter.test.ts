...
import { normalizeRuntimeErrorReport, RuntimeErrorReporter } from './runtime-error-reporter.ts';
...
class TestRuntimeErrorReporterSink implements RuntimeErrorReporterSinkInterface {
  readonly reportMock;
